...
import {
  ...
  useFocusGuards,
  useId
} from "./chunk-667LS2NL.js";
import {
  usePrevious,
  useSize
} from "./chunk-4W2WKNRH.js";
import {
  composeEventHandlers,
  createContextScope,
  useControllableState,
  useLayoutEffect2
} from "./chunk-6DIF4VFN.js";
import {
  Primitive
} from "./chunk-NNJD6CPP.js";
import {
  require_react_dom
...
var Popper = (props) => {
  ...
  const [placementState, setPlacementState] = React6.useState(void 0);
...
var PopperAnchor = React6.forwardRef(
  (props, forwardedRef) => {
    ...
    const callbackRef = React6.useCallback(
      (node) => {
        ref.current = node;
        if (node) {
          onAnchorChange(node);
...
function SelectProvider(props) {
  ...
  const handleNativeOptionAdd = React8.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React8.useCallback((option) => {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime7.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime7.jsx)(React8.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }
);
...
var SelectContentFragment = React8.forwardRef((props, forwardedRef) => {
...
var SelectArrow = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    return contentContext.position === "popper" ? (0, import_jsx_runtime7.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
